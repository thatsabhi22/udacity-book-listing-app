...
public class SettingsActivity extends AppCompatActivity {
    ...
    public static class BookListPreferenceFragment extends PreferenceFragment
        ...
        public void onCreate(@Nullable Bundle savedInstanceState) {
             ...
             */
            Preference maxResults = findPreference(getString(R.string.settings_max_book_results_key));
